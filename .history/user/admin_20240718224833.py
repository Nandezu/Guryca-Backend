    ...
    def save_model(self, request, obj, form, change):
        if change:
            ...
            if old_obj.subscription_type != obj.subscription_type:
                super().save_model(request, obj, form, change)  # Nejprve uložte objekt
                if 'annual' in obj.subscription_type:
                    obj.update_subscription(obj.subscription_type, duration=365)
                else:
