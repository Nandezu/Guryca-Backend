...
class CustomUserViewSet(viewsets.ModelViewSet):
    ...
    def get_tryon_results(self, request, pk=None):
        ...
        # Limit the number of try-on results to 20
        if tryon_results.count() > 20:
            excess_results = tryon_results.count() - 20
...
def cancel_subscription(request):
    ...
    return Response({
        'message': 'Subscription cancellation scheduled successfully. You will retain access until the end of the current period.',
        'subscription_details': CustomUserSerializer(user).data
    }, status=status.HTTP_200_OK)
...
def get_available_plans(request):
    plans = [
        ...
        },
        {
            ...
            'price': '$96',
            'features': ['50 VIRTUAL TRY-ONS monthly', '5 PROFILE IMAGES monthly', '20 TRY-ON RESULTS monthly'],
            'ai_section': True,
            'new_section': True
        },
        {
            ...
            'price': '$150',
            'features': ['100 VIRTUAL TRY-ONS monthly', '8 PROFILE IMAGES monthly', '40 TRY-ON RESULTS monthly'],
            'ai_section': True,
            'new_section': True
        },
        {
            ...
            'price': '$250',
            'features': ['300 VIRTUAL TRY-ONS monthly', '20 PROFILE IMAGES monthly', '60 TRY-ON RESULTS monthly'],
            'ai_section': True,
            'new_section': True
        }
    ]
