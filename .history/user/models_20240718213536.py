...
class CustomUser(AbstractUser):
    ...
    def update_subscription(self, new_type=None, duration=30):
        ...
        self.save(update_fields=['subscription_type', 'subscription_start_date', 'subscription_end_date', 'virtual_try_ons_remaining', 'profile_images_remaining', 'try_on_results_remaining', 'is_cancelled'])
    ...
    def check_and_cancel_subscription(self):
        if self.is_cancelled and timezone.now() > self.subscription_end_date:
            self.update_subscription('free')
    ...
    def save(self, *args, **kwargs):
        ...
        self.check_and_cancel_subscription()
