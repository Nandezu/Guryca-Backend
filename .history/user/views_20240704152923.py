...
class CustomUserViewSet(viewsets.ModelViewSet):
    ...
    def upload_profile_image(self, request, pk=None):
        ...
        local_path = f'profile_images/{unique_filename}'
        user.profile_image.save(local_path, image, save=False)
        ...
        try:
            ...
            # Nahrání souboru s explicitním Content-Type a veřejným přístupem
            s3.upload_fileobj(
                image,
                bucket_name,
                s3_file_name,
