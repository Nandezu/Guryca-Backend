...
def resend_confirmation(request):
    ...
    subject = 'Confirm your email for NANDEZU'
    message = f'Your new confirmation code is: {user.confirmation_code}'
    from_email = settings.DEFAULT_FROM_EMAIL
    recipient_list = [user.email]
    send_mail(subject, message, from_email, recipient_list)
...
def change_email(request):
    ...
    # Odeslání nového potvrzovacího e-mailu
    subject = 'Confirm your new email for NANDEZU'
    message = f'Your confirmation code for your new email is: {user.confirmation_code}'
    from_email = settings.DEFAULT_FROM_EMAIL
