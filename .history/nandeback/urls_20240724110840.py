...
urlpatterns = [
    ...
    path('user/confirm_email/', confirm_email, name='confirm-email'),
    path('user/resend_confirmation/', resend_confirmation, name='resend-confirmation'),
    
    # Nové cesty pro reset hesla
