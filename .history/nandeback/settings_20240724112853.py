...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'postmaster@sandboxe9ed201f24b34e3fa6f8a2e3d4d01508.mailgun.org'
EMAIL_HOST_PASSWORD = 'vaše-skutečné-smtp-heslo-z-mailgunu'  # Nahraďte skutečným SMTP heslem z Mailgunu
DEFAULT_FROM_EMAIL = 'noreply@sandboxe9ed201f24b34e3fa6f8a2e3d4d01508.mailgun.org'

# Mailgun specifické nastavení
...
if os.environ.get('NANDEZU_ENV') == 'production':
    EXPO_SCHEME = 'nandefrond'  # nebo jiné schéma, které si zvolíte pro vaši aplikaci
    PASSWORD_RESET_URL = f'{EXPO_SCHEME}://reset-password'
else:
    # Pro vývoj a testování
    EXPO_DEV_URL = 'exp://192.168.0.106:19000'  # Upravte IP adresu podle vašeho počítače
